...
describe('TeamSearchBar', () => {
  ...
  describe('Rendering', () => {
    it('should render search input with placeholder', () => {
      renderWithProviders(<TeamSearchBar search="" onSearchChange={mockOnSearchChange} />);
    ...
    it('should display current search value', () => {
      renderWithProviders(<TeamSearchBar search="alpha" onSearchChange={mockOnSearchChange} />);
