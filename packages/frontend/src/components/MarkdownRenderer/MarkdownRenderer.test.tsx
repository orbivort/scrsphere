...
describe('MarkdownRenderer Component', () => {
  ...
  describe('Basic Rendering Tests', () => {
    ...
    it('should render empty content without errors', () => {
      expect(() => renderWithProviders(<MarkdownRenderer content="" />)).not.toThrow();
    });
  ...
  describe('Custom Components Tests', () => {
    ...
    it('should allow custom components to override heading styles', () => {
      ...
      renderWithProviders(
        <MarkdownRenderer content={content} customComponents={{ h1: CustomH1 }} />
      );
  ...
  describe('ClassName Prop Tests', () => {
    ...
    it('should handle empty className', () => {
      const { container } = renderWithProviders(<MarkdownRenderer content="# Test" className="" />);
...
[Link](https://example.com)`;
  ...
  describe('Edge Cases', () => {
    it('should handle very long content', () => {
      ...
      expect(() => renderWithProviders(<MarkdownRenderer content={content} />)).not.toThrow();
    });
  ...
  describe('Default Components Behavior', () => {
    ...
    it('should apply list class to ul and ol', () => {
      ...
      renderWithProviders(<MarkdownRenderer content={ulContent} />);
